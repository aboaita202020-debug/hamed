"""Central coordinator for Hamed AI, including the 15-brain council."""
...
class HamedOrchestrator:
    """Central coordinator for business agents and the 15-role AI council."""
    def __init__(self, db: Optional[Database] = None, search_provider: Optional[SearchProvider] = None, max_retries: int = 2, brain_provider=None):
        ...
        for agent_cls in (OpportunityHunterAgent, SalesAgent, NegotiationAgent, RevenueAgent, ReportingAgent, FactCheckAgent):
    ...
    def consult_brains(self, task: str, context: str = "", roles: Optional[list[str]] = None) -> dict:
        """Run expert deliberation and final CEO judgment."""
